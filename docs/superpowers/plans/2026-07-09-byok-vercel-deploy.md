...
```bash
git rm src/app/api/extract/route.ts src/app/api/start-file-upload/route.ts src/app/api/upload-chunk/route.ts src/app/api/upload-pdf/route.ts src/lib/gemini-server.ts src/lib/gemini-file-upload.ts
